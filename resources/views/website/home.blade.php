    ...
    @if(count($latestArticel)>0)
        <section>
            <div class="container">
                ...
                <div class="row">
                    @foreach($latestArticel as $latestArticel)
                        <div class="col-lg-4 mb-4">
                            <div class="card h-100">
                                <h4 class="card-header">{{$latestArticel->title}}</h4>
                                <img class="card-img-top" src="{{url('images/articels/'.$latestArticel->image)}}" alt="">
                                <div class="card-body">
                                    <p class="card-text">{{$latestArticel->short_desc}}</p>
                                </div>
                                <div class="card-footer">
                                    <a href="{{route("news_de",[$latestArticel->id])}}" class="btn btn-primary">see More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        ...
                        <div class="card-footer">
                            <a href="{{route("news_de",[$latestArticel->id])}}" class="btn btn-primary">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 portfolio-item">
