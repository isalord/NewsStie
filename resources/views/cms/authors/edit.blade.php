            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form role="form" method="post" action="{{route("author.con.update",[$author->id])}}">
                                @csrf
                                @method('PUt')
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="first_name" value="{{$author->first_name}}" type="text"
                                ...
                                <div class="row">
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="last_name" value="{{$author->last_name}}" type="text"
