            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route("cat.con.create")}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Create</p>
                                </a>
                            <li class="nav-item">
                                <a href="{{route("cat.con.index")}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Index</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('art.con.create')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Create</p>
                                </a>
                            <li class="nav-item">
                                <a href="{{route("art.con.index")}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Index</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('author.con.create')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Create</p>
                                </a>
                            <li class="nav-item">
                                <a href="{{route("author.con.index")}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Index</p>
                                </a>
                            </li>
